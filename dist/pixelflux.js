      ...
      if (h.faces && h.faces[k]) {
        ...
        if (j) {
          if (T.push(new p.MeshLambertMaterial({
            ...
            const C = y.uv[0] / 16, N = 1 - y.uv[1] / 16, v = y.uv[2] / 16, Y = 1 - y.uv[3] / 16, M = V * 4;
            P.setXY(M + 0, C, N), P.setXY(M + 1, v, N), P.setXY(M + 2, C, Y), P.setXY(M + 3, v, Y);
          }
        } else
